<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="tableList" @selection-change="handleSelectionChange" border>
      ...
      <el-table-column label="表名称" align="center" prop="tableName" :show-overflow-tooltip="true" width="160" />
      <el-table-column label="表描述" align="center" prop="tableComment" :show-overflow-tooltip="true" width="180" />
  ...
  methods: {
    ...
    handleGenTable(row) {
      ...
      if (row.genType === "1") {
        ...
        this.$download.zip("/tool/gen/batchGenCode?tables=" + tableNames, "zcii");
      }
    },
    /** 同步数据库操作 */
    handleSynchDb(row) {
